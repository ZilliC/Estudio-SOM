...
export const preguntas = [
  ...
  // ── UNIDAD 4: Windows Server ─────────────────────────────
  {
    ...
    unidad: 4,
    texto:
      "¿Qué distingue principalmente a un sistema operativo de servidor (como Windows Server) de uno de escritorio?",
    opciones: [
      "Solo puede ejecutar un programa a la vez",
      "Está optimizado para gestionar de forma centralizada usuarios, recursos y servicios de red, con énfasis en estabilidad y disponibilidad continua",
      "No permite la conexión de varios usuarios al mismo tiempo",
      "Carece de interfaz gráfica en todas sus versiones",
    ],
    correcta: 1,
    explicacion:
      "Un SO de servidor se diseña para administrar de forma centralizada usuarios, recursos compartidos y servicios de red, priorizando escalabilidad, estabilidad y disponibilidad continua, a diferencia de uno de escritorio pensado para un único usuario.",
  },
  {
    id: 20,
    unidad: 4,
    texto:
      "En la administración de redes, ¿cuál es la función principal de un servicio de directorio (como Active Directory)?",
    opciones: [
      "Almacenar el contenido de los archivos de cada usuario",
      "Cifrar todo el tráfico que circula por la red",
      "Centralizar la identidad, autenticación y autorización, organizando objetos (usuarios, equipos, grupos) de forma jerárquica",
      "Asignar direcciones IP a los dispositivos de la red",
    ],
    correcta: 2,
    explicacion:
      "Un servicio de directorio mantiene una base de datos centralizada de los objetos de la red y gestiona quién es cada uno y a qué puede acceder (autenticación y autorización), lo que permite administrar grandes organizaciones desde un único punto.",
  },
  {
    id: 21,
    unidad: 4,
    texto:
      "Un sistema operativo de servidor amplía sus capacidades activando 'roles' o servicios (servidor web, DNS, acceso remoto). ¿Qué ventaja aporta este enfoque modular?",
    opciones: [
      "Permite habilitar solo las funciones necesarias, reduciendo la superficie de ataque y el consumo de recursos",
      "Obliga a instalar todos los servicios disponibles desde el inicio",
      "Impide que el servidor ofrezca más de un servicio a la vez",
      "Elimina la necesidad de aplicar actualizaciones de seguridad",
    ],
    correcta: 0,
    explicacion:
      "Activar únicamente los roles requeridos aplica el principio de mínima exposición: cuantos menos servicios corren, menor es la superficie de ataque, el consumo de recursos y la complejidad de mantenimiento del servidor.",
  },
  {
    id: 22,
    unidad: 4,
    texto:
      "¿Por qué la administración remota es una capacidad esencial en un sistema operativo de servidor?",
    opciones: [
      "Porque los servidores no pueden tener teclado ni monitor conectados",
      "Porque elimina la necesidad de credenciales de acceso",
      "Porque sustituye por completo a las copias de seguridad",
      "Porque los servidores suelen residir en centros de datos y deben gestionarse a distancia de forma segura",
    ],
    correcta: 3,
    explicacion:
      "Los servidores normalmente operan en salas o centros de datos sin atención física directa. La administración remota (escritorio remoto, shells seguras) permite configurarlos y supervisarlos desde cualquier ubicación protegiendo el acceso.",
  },
  {
    id: 23,
    unidad: 4,
    texto:
      "¿Cuál es el principal beneficio de automatizar tareas administrativas mediante scripts y programadores de tareas en un servidor?",
    opciones: [
      "Que el servidor deje de necesitar mantenimiento",
      "Ejecutar tareas repetitivas de forma consistente, programada y sin intervención manual, reduciendo errores",
      "Aumentar la velocidad física del procesador",
      "Evitar tener que definir permisos de usuario",
    ],
    correcta: 1,
    explicacion:
      "La automatización (scripts más tareas programadas) hace que operaciones repetitivas —respaldos, limpiezas, despliegues— se ejecuten de forma idéntica y puntual sin depender de que un administrador las realice a mano, minimizando los errores humanos.",
  },
  // ── UNIDAD 5: GNU/Linux ──────────────────────────────────
  {
    id: 24,
  ...
  // ── UNIDAD 6: BSD ────────────────────────────────────────
  {
    ...
    unidad: 6,
    texto:
      "¿Cuál es una ventaja general del modelo de código abierto, presente en los sistemas tipo BSD?",
    opciones: [
      "Garantiza que el sistema nunca necesite actualizaciones",
      "Permite auditar, modificar y adaptar el código, lo que favorece la seguridad y la portabilidad a distinto hardware",
      "Impide que la comunidad participe en su desarrollo",
      "Obliga a pagar una licencia por cada copia instalada",
    ],
    correcta: 1,
    explicacion:
      "Que el código fuente esté disponible permite revisarlo (detectar y corregir fallos), adaptarlo a nuevas arquitecturas y que una comunidad amplia contribuya, lo que suele traducirse en mayor transparencia, portabilidad y seguridad.",
  },
  {
    id: 32,
    unidad: 6,
    texto:
      "¿Cuál es la función general de un gestor de paquetes (como pkg en BSD o APT en Linux)?",
    opciones: [
      "Compilar el kernel cada vez que se enciende el equipo",
      "Cifrar los archivos del usuario en el disco",
      "Reemplazar al sistema de archivos del equipo",
      "Instalar, actualizar y eliminar software resolviendo automáticamente sus dependencias desde repositorios",
    ],
    correcta: 3,
    explicacion:
      "Un gestor de paquetes automatiza la instalación, actualización y eliminación de software y —lo más importante— resuelve las dependencias, descargando desde repositorios todo lo que cada programa necesita para funcionar.",
  },
  {
    id: 33,
    unidad: 6,
    texto:
      "Los sistemas tipo BSD son multiusuario y de multitarea apropiativa. ¿Qué implica que un sistema operativo sea 'multiusuario'?",
    opciones: [
      "Que solo puede ejecutar una aplicación a la vez",
      "Que todos los usuarios comparten la misma cuenta y los mismos permisos",
      "Que varios usuarios pueden trabajar de forma simultánea con sus recursos y permisos aislados entre sí",
      "Que el sistema no requiere autenticación para iniciar sesión",
    ],
    correcta: 2,
    explicacion:
      "Un sistema multiusuario permite que varias personas usen el equipo a la vez, cada una con su identidad, archivos y permisos protegidos del resto; el SO se encarga de aislar y arbitrar el acceso a los recursos compartidos.",
  },
  {
    id: 34,
    unidad: 6,
    texto:
      "En los sistemas tipo Unix se recomienda no trabajar de forma habitual como superusuario (root), sino usar una cuenta normal y elevar privilegios solo cuando se necesite. ¿Qué principio de seguridad aplica esto?",
    opciones: [
      "El principio de mínimo privilegio: operar con los permisos mínimos necesarios para limitar el daño ante un error o un ataque",
      "El principio de máxima disponibilidad de los datos",
      "El principio de que todo usuario debe tener permisos de administrador",
      "El principio de cifrar siempre el sistema de archivos",
    ],
    correcta: 0,
    explicacion:
      "El principio de mínimo privilegio busca que cada usuario o proceso disponga solo de los permisos imprescindibles. Reservar el uso de root para cuando es estrictamente necesario reduce el impacto de errores y de una eventual intrusión.",
  },
  {
    id: 35,
    unidad: 6,
    texto:
      "En los sistemas tipo Unix, herramientas como cron permiten programar tareas. ¿Cuál es el propósito general de un planificador de tareas del sistema?",
    opciones: [
      "Asignar memoria virtual a los procesos en ejecución",
      "Ejecutar comandos o scripts de forma automática en momentos o intervalos definidos, sin intervención del usuario",
      "Gestionar los permisos de los archivos del sistema",
      "Compilar los paquetes antes de instalarlos",
    ],
    correcta: 1,
    explicacion:
      "Un planificador de tareas (como cron) ejecuta automáticamente comandos o scripts en fechas, horas o intervalos predefinidos —respaldos nocturnos, limpiezas periódicas—, sin que nadie deba lanzarlos manualmente.",
  },
